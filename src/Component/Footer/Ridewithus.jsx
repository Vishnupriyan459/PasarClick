          ...
          <div className="w-[90%] mx-auto my-[3rem]">
            ...
            <div className="flex flex-col tablet:flex-row justify-between gap-2 items-center mt-7">
              <div className="flex flex-col justify-center">
                <img src="/Asset/footer/frame1.svg" className="w-[250px] h-[250px] tablet:w-[200px] tablet:h-[200px] laptop:w-[250px] laptop:h-[250px]" />
                <div className="flex mt-[1rem] gap-[1rem] items-center justify-center tablet:justify-start">
                  <p className="font-[600] text-[20px] tablet:text-[28px] laptop:text-[33px] ">3Lakh+</p>
              ...
              <div className="flex flex-col justify-center">
                <img src="/Asset/footer/frame2.svg" className="w-[250px] h-[250px] tablet:w-[200px] tablet:h-[200px] laptop:w-[250px] laptop:h-[250px]"/>
                <div className="flex mt-[1rem] gap-[1rem] items-center justify-center tablet:justify-start">
                  <p className="font-[600] text-[20px] tablet:text-[28px] laptop:text-[33px] ">500+</p>
                  <div className="font-[400] text-[15px] leading-[19px] text-[#364A15]">
                    <p>Cities</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col justify-center">
                <img src="/Asset/footer/frame3.svg" className="w-[250px] h-[250px] tablet:w-[200px] tablet:h-[200px] laptop:w-[250px] laptop:h-[250px]" />
                <div className="flex mt-[1rem] gap-[1rem] items-center justify-center tablet:justify-start">
                  <p className="font-[600] text-[20px] tablet:text-[28px] laptop:text-[33px] ">10Cr+</p>
                  <div className="font-[400] text-[15px] leading-[19px] text-[#364A15]">
                    <p>Happy</p>
                    <p>deliveries</p>
                  </div>
              ...
              <div className="flex flex-col justify-center">
                <img src="/Asset/footer/frame4.svg" className="w-[250px] h-[250px] tablet:w-[200px] tablet:h-[200px] laptop:w-[250px] laptop:h-[250px]"/>
                <div className="flex mt-[1rem] gap-[1rem] items-center justify-center tablet:justify-start">
                  <p className="font-[600] text-[20px] tablet:text-[28px] laptop:text-[33px] ">2Lakh+</p>
                  <div className="font-[400] text-[15px] leading-[19px] text-[#364A15]">
                    <p>Happy</p>
                    <p>Partner</p>
                  </div>
              ...
              <div className="flex flex-col tablet:flex-row gap-3 justify-around items-center tablet:items-start mt-6">
                ...
                <p className="w-[85%] mx-auto mt-9 font-[400] text-[6px] tablet:text-[12px]  laptop:text-[16px]">
                  ...
                  <div className="m-5 flex gap-3 items-center">
                    <img src="/Asset/footer/Profile.svg" alt="" className="w-[25px] h-[25px] tablet:w-[35px] tablet:h-[35px] laptop:w-[65px] laptop:h-[65px] " />
