        ...
        <div className=" w-[95%] mx-auto">
          <div className="">
            <div className="flex flex-col tablet:gap-5 tablet:flex-row">
              <div className="font-[400] text-[16px] tablet:text-[36px] text-[#364A15] leading-[46.99px]">
              ...
              <div className="self-start tablet:self-end text-[8px] tablet:text-[14px] leading-[18.27px]">
                {/* Showing 1-{Math.min(vendors.products.length, 7)} of {vendors.products.length} results */}
              </div>
            </div>
            ...
            <div className="flex justify-end relative tablet:hidden">
              <div
                className="flex items-center gap-1 text-[10px] text-[#364A15] bg-[#E6E6DD] rounded-full px-[10px] py-[3px]"
